...
import naive_bayesian.naive_manager as n_mamager
...
naive_manager = n_mamager.Naive_manager(df, classified)
naive_manager.create_model()
print(naive_manager.exam_model())
# naive_manager.calc_new_data_by_classified()
